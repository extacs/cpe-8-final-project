...
/* ══════════════════════════════════════════════
   CONTACT SELLER (Fully Functional)
══════════════════════════════════════════════ */
    ...
    fetch("/student-center/apply-moderator/", {
        ...
        .then((data) => {
            if (data.ok) {
                ...
                /* Hide the apply button since they now have a pending application */
...
/* ══════════════════════════════════════════════
   INIT — load listings on page load
══════════════════════════════════════════════ */

/* ══════════════════════════════════════════════
   SMART URL ROUTING (For Notifications)
══════════════════════════════════════════════ */
window.addEventListener('DOMContentLoaded', () => {
    ...
    if (action && listingId && buyerId) {
        // Fetch the data regardless of which modal we are opening
        ...
        // Clean the URL so it doesn't reopen if the user refreshes the page
...
// Ensure the new modals close when clicking the dark background
